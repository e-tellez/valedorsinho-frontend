 ...
 *
 * This is the single source of truth for vertical metadata and their
 * recommended /payments payload fields. Both GET /api/tools/verticals and
 * POST /api/tools/payload-suggested import from here — do NOT duplicate this
 * data in the route files.
 */
